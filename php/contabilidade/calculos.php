...
// Despesas fixas mensais (valores fixos, contabilizados uma vez)
define('DESPESA_ALUGUEL', 2500.00);
define('DESPESA_LUZ', 600.00);
define('DESPESA_AGUA', 250.00);

/**
 * Soma das despesas fixas mensais.
 */
function totalDespesasFixas() {
    return DESPESA_ALUGUEL + DESPESA_LUZ + DESPESA_AGUA;
}
...
function gerarLancamentos() {
    ...
    // Despesas fixas mensais (aluguel, luz, água) - pagas em dinheiro (Caixa)
    $lancamentos[] = [
        'data' => '-',
        'historico' => 'Despesa com Aluguel',
        'debito' => 'Despesas Operacionais',
        'credito' => 'Caixa',
        'valor' => DESPESA_ALUGUEL
    ];
    $lancamentos[] = [
        'data' => '-',
        'historico' => 'Despesa com Energia Elétrica (Luz)',
        'debito' => 'Despesas Operacionais',
        'credito' => 'Caixa',
        'valor' => DESPESA_LUZ
    ];
...
function calcularBalanco() {
    ...
    // Despesas fixas mensais (pagas em dinheiro, saem do caixa)
    $despesas_fixas = totalDespesasFixas();
    $caixa -= $despesas_fixas;

    // Lucro = Receita - Impostos - CMV - Despesas Operacionais
    $lucro_acumulado = $receita_total - $impostos_total - $cmv_total - $despesas_fixas;
...
function calcularDRE() {
    ...
    // Despesas operacionais = despesas fixas (aluguel + luz + água)
    $despesas_operacionais = totalDespesasFixas();
    ...
    return [
        ...
        'despesa_luz' => DESPESA_LUZ,
        'despesa_agua' => DESPESA_AGUA,
...
function getPlanoContas() {
    return [
        ...
        ['cod' => '3.5.1.1', 'nivel' => 4, 'nome' => 'Aluguel'],
        ['cod' => '3.5.1.2', 'nivel' => 4, 'nome' => 'Energia Elétrica (Luz)'],
        ['cod' => '3.5.1.3', 'nivel' => 4, 'nome' => 'Água'],
    ];
}
?>